...
public class KhachHangForm extends javax.swing.JPanel {
    ...
    private final KhachHangBUS service = new KhachHangBUS();
    ...
    public KhachHangForm() {
        ...
        String[] cols = {"ID", "Họ tên", "Ngày sinh", "Giới tính", "Điện thoại", "Email", "Ngày đăng kí"};
        model = new DefaultTableModel(cols, 0);
        table.setModel(model);
        loadAllKhachHangData();
    }
    ...
    private void loadAllKhachHangData(){
        ArrayList<KhachHangDTO> list = service.getKhachHang();
        model.setRowCount(0);
