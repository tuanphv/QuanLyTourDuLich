...
public class InputPhuongTien extends javax.swing.JDialog {
    ...
    /**
     * Creates new form InputPhuongTien
     */
    public InputPhuongTien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputPhuongTien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InputPhuongTien dialog = new InputPhuongTien(new javax.swing.JFrame(), true);
