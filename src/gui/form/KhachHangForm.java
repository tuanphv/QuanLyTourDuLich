...
public class KhachHangForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnDelete = new gui.Components.MyButton();
        btnUpdate = new gui.Components.MyButton();
        btnAdd = new gui.Components.MyButton();
...
public void updateKhachHang(KhachHangDTO kh) {
    ...
    private gui.Components.MyButton btnAdd;
    private gui.Components.MyButton btnDelete;
    private gui.Components.MyButton btnUpdate;
